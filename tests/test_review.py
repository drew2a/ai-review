...
import argparse
from review import get_model, supported_models, process_review
...
def test_process_review():
    ...
    with mock.patch('builtins.open', mock.mock_open(read_data="system prompt\nuser prompt")) as mock_file, \
